frappe.pages['info-tidak-terima-ba'].on_page_load = function(wrapper) {
...
init: function(wrapper){
	...
	this.page = frappe.ui.make_app_page({
		parent: wrapper,
		title: 'Info Tidak Terima Barang',
		single_column: true
	});
...
piutang: function(){
	...
	var data = frappe.call({
		method: 'lestari.gold_selling.page.info_tidak_terima_ba.info_tidak_terima_ba.contoh_report',
		args: {
